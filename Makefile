...
#    Updated: 2021/05/23 14:44:42 by smagdela         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS    =   ft_bzero.c ft_memccpy.c ft_memchr.c ft_memcmp.c ft_memcpy.c ft_memmove.c ft_memset.c \
            ft_strcat.c ft_strchr.c ft_strrchr.c ft_strcpy.c ft_strdup.c ft_strlcat.c ft_strlen.c ft_strncat.c ft_strncpy.c ft_strncmp.c \
